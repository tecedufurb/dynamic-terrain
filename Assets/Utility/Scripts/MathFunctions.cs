...
public static class MathFunctions {
	...
	public static float Sine (float x, float z, float t) {
		return (float) (0.25f * Math.Sin(4f * Math.PI * x + 4f * t) * Math.Sin(2f * Math.PI * z + t) +
		                0.10f * Math.Cos(3f * Math.PI * x + 5f * t) * Math.Cos(5f * Math.PI * z + 3f * t) +
		                0.15f * Math.Sin(Math.PI * x + 0.6f * t));
	}
